...
export const metadata: Metadata = {
  title: 'Aannemer Rotterdam voor verbouwing, renovatie & onderhoud | Woonklasse',
  description:
    'Aannemer in Rotterdam voor verbouwingen, renovaties, aanbouw en woningonderhoud. Eigen vakmensen, vaste prijs vooraf en één projectleider. Vraag een vrijblijvende offerte aan.',
  alternates: { canonical: `${SITE_URL}/${SLUG}` },
  openGraph: {
    title: 'Aannemer Rotterdam voor verbouwing & renovatie | Woonklasse',
    description:
      'Verbouwen in Rotterdam door eigen vakmensen, met vaste prijs vooraf en één projectleider.',
    url: `${SITE_URL}/${SLUG}`,
    type: 'website',
    locale: 'nl_NL',
    siteName: 'Woonklasse',
