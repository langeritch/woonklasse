...
import { CATEGORY_LABEL, type BlogPost } from '@/data/blog';
          ...
          <div className="max-w-[1400px] mx-auto">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
              <div>
                ...
                <h2 className="font-cormorant text-3xl md:text-4xl lg:text-5xl font-light leading-[1.15] max-w-3xl">
                  Recente
                  <br />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-12">
              {recentArticles.map((article) => (
                ...
                >
                  <div className="aspect-[4/3] relative overflow-hidden mb-5 bg-bsv2-charcoal/5">
                    <Image
                  ...
                  <p className="text-bsv2-grey text-sm leading-relaxed line-clamp-2">
                    {article.excerpt}
                  </p>
                </Link>
              ))}
