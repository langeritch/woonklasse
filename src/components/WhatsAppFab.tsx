...
export default function WhatsAppFab() {
  ...
  // Render site-wide incl. the homepage. Only hidden on the internal admin
  // back-office, which is not a public marketing page.
  ...
  return (
    <a
      ...
      title="WhatsApp"
      className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-[60] flex items-center justify-center w-11 h-11 sm:w-14 sm:h-14 rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 hover:scale-105 hover:shadow-xl transition-all duration-300"
    >
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="w-5 h-5 sm:w-7 sm:h-7">
